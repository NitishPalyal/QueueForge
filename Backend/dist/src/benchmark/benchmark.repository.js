...
export async function countInFlight(jobType, since) {
...
export async function getResults(jobType, since) {
...
export async function getBatchInFlightCount(since) {
    const rows = await prisma.$queryRaw `
    SELECT COUNT(*)::int AS "inFlight"
    FROM batches
...
export async function getBatchResults(since) {
    const statusRows = await prisma.$queryRaw `
...
//# sourceMappingURL=benchmark.repository.js.map