...
export const BatchRequestSchema = z.object({
    steps: z
        ...
        .refine((steps) => new Set(steps.map((s) => s.type)).size === steps.length, { message: "each job type can only appear once in a batch" }),
});
//# sourceMappingURL=batchJob.zodSchema.js.map